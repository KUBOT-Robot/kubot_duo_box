...
void BaseDriver::callback_led_status(const kubot_duo_msgs::RawLeds& led_cmd) {
...
void BaseDriver::callback_servo_status(const kubot_duo_msgs::RawServos& servo_cmd) {
